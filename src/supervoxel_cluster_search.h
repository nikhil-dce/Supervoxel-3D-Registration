/*
 * supervoxel_cluster_search.h
 *
 *  Created on: 23-Nov-2016
 *      Author: root
 */

#ifndef SUPERVOXEL_CLUSTER_SEARCH_H_
#define SUPERVOXEL_CLUSTER_SEARCH_H_
  ...
  class PCL_EXPORTS SupervoxelClustering : public pcl::PCLBase<PointT>
  {
    ...
    public:
      ...
      */
      ...
      void
      getLabeledLeafContainerMap (std::map<LeafContainerT*, uint32_t>&) const;
      ...
      typename pcl::SupervoxelClustering<PointT>::OctreeAdjacencyT::Ptr
      getOctreeeAdjacency() ;
    ...
    private:
      ...
      class SupervoxelHelper
      {
        public:
          ...
          void
          getLabeledLeafMap (std::map<LeafContainerT*, uint32_t>&) const;
...
//#include "supervoxel_mi.hpp"
//#include <pcl/segmentation/impl/supervoxel_clustering.hpp>
//#endif


#endif /* SUPERVOXEL_CLUSTER_SEARCH_H_ */
