#ifndef PCL_SEGMENTATION_SUPERVOXEL_CLUSTER_SEARCH_HPP_
#define PCL_SEGMENTATION_SUPERVOXEL_CLUSTER_SEARCH_HPP_
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::SupervoxelClustering<PointT>::getLabeledLeafContainerMap (std::map<typename pcl::SupervoxelClustering<PointT>::LeafContainerT*, uint32_t> &label_leaf_container) const
{
	label_leaf_container.clear ();
	for (typename HelperListT::const_iterator sv_itr = supervoxel_helpers_.cbegin (); sv_itr != supervoxel_helpers_.cend (); ++sv_itr)
	{
		sv_itr -> getLabeledLeafMap (label_leaf_container);
	}
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> typename  pcl::SupervoxelClustering<PointT>::OctreeAdjacencyT::Ptr
pcl::SupervoxelClustering<PointT>::getOctreeeAdjacency()
{

//	pcl::octree::OctreePointCloudAdjacency<PointT>::Ptr adj_octree (new pcl::octree::OctreePointCloudAdjacency<PointT>);
//	for (typename HelperListT::const_iterator sv_itr = supervoxel_helpers_.cbegin (); sv_itr != supervoxel_helpers_.cend (); ++sv_itr)
//	{
//		typename PointCloudT::Ptr voxels;
//		sv_itr->getVoxels (voxels);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT> void
pcl::SupervoxelClustering<PointT>::SupervoxelHelper::getLabeledLeafMap (std::map<typename pcl::SupervoxelClustering<PointT>::LeafContainerT*, uint32_t>& labeledLeafMap) const
{

	typename SupervoxelHelper::const_iterator leaf_itr;
	for ( leaf_itr = leaves_.begin (); leaf_itr != leaves_.end (); ++leaf_itr)
	{
		labeledLeafMap.insert(std::pair<pcl::SupervoxelClustering<PointT>::LeafContainerT*, uint32_t> (*leaf_itr, this -> getLabel ()));
	}
...
#endif    // PCL_SUPERVOXEL_CLUSTER_SEARCH_HPP_
